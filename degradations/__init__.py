"""Innovation-1 degradation package for S2Diff-MH."""
...
def build_degradation(mode: str, *, scale_ratio: int = 4, **kwargs: Any) -> BaseDegradation:
    ...
    raise ValueError(
        f"Unsupported degradation mode {mode!r}; expected bicubic, gaussian_bicubic, or physical"
    )
